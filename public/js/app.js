...
var socket = io();
var currentStatus; // set totalqty into localStorage
...
$(document).ready(function () {
  ...
  $('.successMessage').hide();
  $('.item_add_to_cart_error').hide(); // ajax call from client to server

  $.ajax({
    url: "http://localhost:3100/cart_data",
    // Url of backend (can be python, php, etc..)
    type: "GET",
    // data type (can be get, post, put, delete)
...
function postFunction(pizaa, type, url) {
  ...
  $.ajax({
    url: "http://localhost:3100".concat(url),
    // Url of backend (can be python, php, etc..)
    type: type,
    // data type (can be get, post, put, delete)
    data: pizaa,
...
Object(_admin__WEBPACK_IMPORTED_MODULE_0__["InItAdmin"])(socket); // custom select box
...
document.addEventListener("click", closeAllSelect); // end custom select box

var order = JSON.parse(document.getElementById("hidden_value").value);
var status = document.getElementsByClassName('status_line'); // socket work 
...
__webpack_require__(/*! C:\Users\piyush jain\Desktop\nodejs\realtime piza deliver app\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\piyush jain\Desktop\nodejs\realtime piza deliver app\resources\scss\app.scss */"./resources/scss/app.scss");
